...
//go:generate protoc --go_out=pbdesc --go_opt=paths=source_relative --proto_path=pbdesc --proto_path=common --proto_path=extension --proto_path=../public/pbdesc --proto_path=../public/common --proto_path=../public/extension --proto_path=../../../../atframework/libatapp-go/protocol pbdesc/protocol/pbdesc/*.proto
