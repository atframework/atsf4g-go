module github.com/atframework/atsf4g-go/component-mail
...
replace github.com/atframework/atsf4g-go/component-db => ../db
...
replace github.com/atframework/atsf4g-go/component-uuid => ../uuid

replace github.com/atframework/atsf4g-go/component-async_jobs => ../async_jobs

require (
	github.com/atframework/atsf4g-go/component-async_jobs v0.0.0-00010101000000-000000000000
	...
	github.com/atframework/atsf4g-go/component-uuid v0.0.0
	google.golang.org/protobuf v1.36.9
)

require (
	github.com/atframework/atframe-utils-go v0.0.0 // indirect
