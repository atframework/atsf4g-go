...
// ========================= 注册指令 =========================
func init() {
	cmd.RegisterUserCommand([]string{"quest", "receive"}, QuestReceiveRewardCmd, "<quest_id>", "领取任务奖励", nil)
	cmd.RegisterUserCommand([]string{"quest", "receiveMulti"}, QuestReceiveRewardsCmd, "<quest_id1> [quest_id2] ...", "批量领取任务奖励", nil)
	cmd.RegisterUserCommand([]string{"quest", "activate"}, QuestActivateCmd, "<activate_id>", "激活任务", nil)
}
