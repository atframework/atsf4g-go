...
import (
	...
	impl "github.com/atframework/atsf4g-go/service-lobbysvr/logic/building"
...
func CreateUserBuildingManager(owner *data.User) impl.UserBuildingManager {
...
func init() {
	data.RegisterUserModuleManagerCreator[impl.UserBuildingManager](func(owner *data.User) data.UserModuleManagerImpl {
		return CreateUserBuildingManager(owner)
	})
}
