...
package lobbysvr_logic_lottery_action
...
func (t *TaskActionLotteryPoolLottery) Name() string {
	return "TaskActionLotteryPoolLottery"
}

func (t *TaskActionLotteryPoolLottery) Run(_startData *component_dispatcher.DispatcherStartData) error {
