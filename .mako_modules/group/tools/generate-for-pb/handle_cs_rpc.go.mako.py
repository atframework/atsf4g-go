...
_magic_number = 10
_modified_time = 1759151109.8619878
_enable_loop = True
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_locals.update(__M_dict_builtin([(__M_key, __M_locals_builtin_stored[__M_key]) for __M_key in ['module_name','imported_sub_modules'] if __M_key in __M_locals_builtin_stored]))
